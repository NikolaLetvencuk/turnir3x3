    ...
    <div className="flex items-center justify-between gap-3">
      <div className="min-w-0">
        ...
        <p className="text-xs text-zinc-500">
          Slika: <code className="font-mono">/public/ads/popup.png</code>. Kad uključiš, prikazuje se posetiocima na početnoj. Posle dismiss-a, isti posetilac je ne vidi 24h. Toggle OFF → ON resetuje sve dismiss-eve.
        </p>
      </div>
      <button
        type="button"
